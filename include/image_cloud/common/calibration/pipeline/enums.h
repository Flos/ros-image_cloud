...
namespace pcl_filter{
    DEFINE_ENUM_WITH_STRING_CONVERSIONS(Filter3d, (OFF)(DEPTH)(DEPTH_INTENSITY)(DEPTH_EDGE)(NORMAL_DIFF)(RANGE_BORDERS)(DEPTH_NEIGHBORS)(DEPTH_EDGE_PROJECTION)(HIT_SAME_POINT)(DEPTH_RADIUS)(OTHER)(NR_ENUMS))
//	enum Filter3d
//	{
//		OFF = 0,
//		DEPTH = 1,
